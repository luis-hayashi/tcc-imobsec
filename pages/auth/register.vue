<script setup>
    ...
    async function signUp() {
        try {
            ...
            sucessMsg.value = "Sucesso! Confirme seu e-mail para seguir os próximos passos.";
        } catch (error) {
    ...
    <body class="bodii">
            ...
            <div class="bg">
                <div class="card">
                    <div class="cardazul">
                        <div class="logo">
                        <img src='../../images/logo branca.png' class="logoimg" />
                        </div>
                            <div class="white-text">
                            <p class="titulo"> Bem-Vindo ao iMobSec!</p>
                            <p class="texto-descritivo">Faça o seu login e acesse sua conta agora mesmo!</p>
                        </div>
                        <div class="button">
                            <a href="/auth/login" class="entrar">ENTRAR</a>
                        </div>
                    </div>
                    <div class="cardbranco">
                        ...
                        <div class="blue-text">
                            <p class="crie">Crie sua conta!</p>
                            <p class="linkempresarial">criando uma conta empresarial? <a href="/auth/empresarial">clique aqui!</a></p>
                        </div>
                        <form @submit.prevent="signUp()">
                            ...
                            <div class="textboxs"> 
                                <input type="text" v-model="username" placeholder="Usuário" class="box" name="username" />
